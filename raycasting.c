...
/*   Updated: 2026/02/02 14:44:51 by sakdil           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	// 1. Balık gözü efektini önleyen dik mesafe hesabı
	if (game->ray.side == 0)
		game->ray.wall_distance = (game->ray.side_dist_x
				- game->ray.delta_dist_x);
	else
		game->ray.wall_distance = (game->ray.side_dist_y
				- game->ray.delta_dist_y);
